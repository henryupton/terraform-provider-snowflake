...
func TestAcc_ApiAuthenticationIntegrationWithJwtBearer_BasicUseCase(t *testing.T) {
	...
	basic := model.ApiAuthenticationIntegrationWithJwtBearer("test", id.Name(), true, "test_issuer", "test_client_id", "test_client_secret")

	complete := model.ApiAuthenticationIntegrationWithJwtBearer("test", id.Name(), true, "test_issuer", "test_client_id", "test_client_secret").
		WithComment(comment)
