...
func TestAcc_Views(t *testing.T) {
	...
	viewId := testClient().Ids.RandomSchemaObjectIdentifierWithPrefix(prefix + "1")
	viewId2 := testClient().Ids.RandomSchemaObjectIdentifierInSchemaWithPrefix(prefix+"2", schema.ID())
