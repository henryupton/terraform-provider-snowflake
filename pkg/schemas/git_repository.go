...
// DescribeGitRepositorySchema represents output of DESCRIBE query for the single GitRepository.
var DescribeGitRepositorySchema = map[string]*schema.Schema{
	"created_on": {
...
func GitRepositoryDetailsToSchema(gitRepository sdk.GitRepository) map[string]any {
