...
import (
	...
	resourcemodel "github.com/henryupton/terraform-provider-snowflakier/pkg/acceptance/bettertestspoc/config/model/gen"
...
var (
	...
	AllTemplates = []*template.Template{genhelpers.PreambleTemplate, DefinitionTemplate, resourcemodel.BuildersTemplate}
)
