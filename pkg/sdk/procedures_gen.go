...
type ProcedurePackage struct {
	ProcedurePackage string `ddl:"keyword,single_quotes"`
}

type ProcedureImport struct {
	ProcedureImport string `ddl:"keyword,single_quotes"`
}
...
func (v *Procedure) ObjectType() ObjectType {
	return ObjectTypeProcedure
}
