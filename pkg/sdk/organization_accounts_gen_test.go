...
func TestOrganizationAccounts_Create(t *testing.T) {
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateOrganizationAccountOptions)(nil)
...
func TestOrganizationAccounts_Alter(t *testing.T) {
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*AlterOrganizationAccountOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
	...
	t.Run("validation: exactly one field from [opts.Set opts.Unset opts.SetTags opts.UnsetTags opts.RenameTo opts.DropOldUrl] should be present", func(t *testing.T) {
		opts := defaultOpts()
	...
	t.Run("validation: exactly one field from [opts.Set opts.Unset opts.SetTags opts.UnsetTags opts.RenameTo opts.DropOldUrl] should be present - more set", func(t *testing.T) {
		opts := defaultOpts()
		opts.Set = new(OrganizationAccountSet)
		opts.Unset = new(OrganizationAccountUnset)
		assertOptsInvalidJoinedErrors(t, opts, errExactlyOneOf("AlterOrganizationAccountOptions", "Set", "Unset", "SetTags", "UnsetTags", "RenameTo", "DropOldUrl"))
	...
	t.Run("validation: exactly one field from [opts.Set.Parameters opts.Set.ResourceMonitor opts.Set.PasswordPolicy opts.Set.SessionPolicy opts.Set.Comment] should be present", func(t *testing.T) {
		opts := defaultOpts()
		opts.Set = new(OrganizationAccountSet)
	...
	t.Run("validation: exactly one field from [opts.Set.Parameters opts.Set.ResourceMonitor opts.Set.PasswordPolicy opts.Set.SessionPolicy opts.Set.Comment] should be present - more set", func(t *testing.T) {
		opts := defaultOpts()
		opts.Set = &OrganizationAccountSet{
			ResourceMonitor: Pointer(randomAccountObjectIdentifier()),
			Comment:         Pointer(random.Comment()),
		}
		assertOptsInvalidJoinedErrors(t, opts, errExactlyOneOf("AlterOrganizationAccountOptions.Set", "Parameters", "ResourceMonitor", "PasswordPolicy", "SessionPolicy", "Comment"))
	})

	t.Run("validation: exactly one field from [opts.Unset.Parameters opts.Unset.ResourceMonitor opts.Unset.PasswordPolicy opts.Unset.SessionPolicy opts.Unset.Comment] should be present", func(t *testing.T) {
		opts := defaultOpts()
		opts.Unset = new(OrganizationAccountUnset)
	...
	t.Run("validation: exactly one field from [opts.Unset.Parameters opts.Unset.ResourceMonitor opts.Unset.PasswordPolicy opts.Unset.SessionPolicy opts.Unset.Comment] should be present - more present", func(t *testing.T) {
		opts := defaultOpts()
...
func TestOrganizationAccounts_Show(t *testing.T) {
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*ShowOrganizationAccountOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
