...
func handleAccountParametersCreate(d *schema.ResourceData, parameters *sdk.AccountParameters) diag.Diagnostics {
	diags := JoinDiags(
		// Bool parameters
		handleParameterCreate(d, sdk.AccountParameterAbortDetachedQuery, &parameters.AbortDetachedQuery),
		handleParameterCreate(d, sdk.AccountParameterAllowClientMFACaching, &parameters.AllowClientMFACaching),
		handleParameterCreate(d, sdk.AccountParameterAllowIDToken, &parameters.AllowIDToken),
		handleParameterCreate(d, sdk.AccountParameterAutocommit, &parameters.Autocommit),
		handleParameterCreate(d, sdk.AccountParameterClientEnableLogInfoStatementParameters, &parameters.ClientEnableLogInfoStatementParameters),
		handleParameterCreate(d, sdk.AccountParameterClientMetadataRequestUseConnectionCtx, &parameters.ClientMetadataRequestUseConnectionCtx),
		handleParameterCreate(d, sdk.AccountParameterClientMetadataUseSessionDatabase, &parameters.ClientMetadataUseSessionDatabase),
		handleParameterCreate(d, sdk.AccountParameterClientResultColumnCaseInsensitive, &parameters.ClientResultColumnCaseInsensitive),
		handleParameterCreate(d, sdk.AccountParameterClientSessionKeepAlive, &parameters.ClientSessionKeepAlive),
		handleParameterCreate(d, sdk.AccountParameterDisableUiDownloadButton, &parameters.DisableUiDownloadButton),
		handleParameterCreate(d, sdk.AccountParameterDisableUserPrivilegeGrants, &parameters.DisableUserPrivilegeGrants),
		handleParameterCreate(d, sdk.AccountParameterEnableAutomaticSensitiveDataClassificationLog, &parameters.EnableAutomaticSensitiveDataClassificationLog),
		handleParameterCreate(d, sdk.AccountParameterEnableEgressCostOptimizer, &parameters.EnableEgressCostOptimizer),
		handleParameterCreate(d, sdk.AccountParameterEnableIdentifierFirstLogin, &parameters.EnableIdentifierFirstLogin),
		handleParameterCreate(d, sdk.AccountParameterEnableInternalStagesPrivatelink, &parameters.EnableInternalStagesPrivatelink),
		handleParameterCreate(d, sdk.AccountParameterEnableTriSecretAndRekeyOptOutForImageRepository, &parameters.EnableTriSecretAndRekeyOptOutForImageRepository),
		handleParameterCreate(d, sdk.AccountParameterEnableTriSecretAndRekeyOptOutForSpcsBlockStorage, &parameters.EnableTriSecretAndRekeyOptOutForSpcsBlockStorage),
		handleParameterCreate(d, sdk.AccountParameterEnableUnhandledExceptionsReporting, &parameters.EnableUnhandledExceptionsReporting),
		handleParameterCreate(d, sdk.AccountParameterEnableUnloadPhysicalTypeOptimization, &parameters.EnableUnloadPhysicalTypeOptimization),
		handleParameterCreate(d, sdk.AccountParameterEnableUnredactedQuerySyntaxError, &parameters.EnableUnredactedQuerySyntaxError),
		handleParameterCreate(d, sdk.AccountParameterEnableUnredactedSecureObjectError, &parameters.EnableUnredactedSecureObjectError),
		handleParameterCreate(d, sdk.AccountParameterEnforceNetworkRulesForInternalStages, &parameters.EnforceNetworkRulesForInternalStages),
		handleParameterCreate(d, sdk.AccountParameterErrorOnNondeterministicMerge, &parameters.ErrorOnNondeterministicMerge),
		handleParameterCreate(d, sdk.AccountParameterErrorOnNondeterministicUpdate, &parameters.ErrorOnNondeterministicUpdate),
		handleParameterCreate(d, sdk.AccountParameterExternalOAuthAddPrivilegedRolesToBlockedList, &parameters.ExternalOAuthAddPrivilegedRolesToBlockedList),
		handleParameterCreate(d, sdk.AccountParameterJdbcTreatDecimalAsInt, &parameters.JdbcTreatDecimalAsInt),
		handleParameterCreate(d, sdk.AccountParameterJdbcTreatTimestampNtzAsUtc, &parameters.JdbcTreatTimestampNtzAsUtc),
		handleParameterCreate(d, sdk.AccountParameterJdbcUseSessionTimezone, &parameters.JdbcUseSessionTimezone),
		handleParameterCreate(d, sdk.AccountParameterJsTreatIntegerAsBigInt, &parameters.JsTreatIntegerAsBigInt),
		handleParameterCreate(d, sdk.AccountParameterNoorderSequenceAsDefault, &parameters.NoorderSequenceAsDefault),
		handleParameterCreate(d, sdk.AccountParameterOAuthAddPrivilegedRolesToBlockedList, &parameters.OAuthAddPrivilegedRolesToBlockedList),
		handleParameterCreate(d, sdk.AccountParameterOdbcTreatDecimalAsInt, &parameters.OdbcTreatDecimalAsInt),
		handleParameterCreate(d, sdk.AccountParameterPeriodicDataRekeying, &parameters.PeriodicDataRekeying),
		handleParameterCreate(d, sdk.AccountParameterPipeExecutionPaused, &parameters.PipeExecutionPaused),
		handleParameterCreate(d, sdk.AccountParameterPreventUnloadToInlineURL, &parameters.PreventUnloadToInlineURL),
		handleParameterCreate(d, sdk.AccountParameterPreventUnloadToInternalStages, &parameters.PreventUnloadToInternalStages),
		handleParameterCreate(d, sdk.AccountParameterQuotedIdentifiersIgnoreCase, &parameters.QuotedIdentifiersIgnoreCase),
		handleParameterCreate(d, sdk.AccountParameterReplaceInvalidCharacters, &parameters.ReplaceInvalidCharacters),
		handleParameterCreate(d, sdk.AccountParameterRequireStorageIntegrationForStageCreation, &parameters.RequireStorageIntegrationForStageCreation),
		handleParameterCreate(d, sdk.AccountParameterRequireStorageIntegrationForStageOperation, &parameters.RequireStorageIntegrationForStageOperation),
		handleParameterCreate(d, sdk.AccountParameterSsoLoginPage, &parameters.SsoLoginPage),
		handleParameterCreate(d, sdk.AccountParameterStrictJsonOutput, &parameters.StrictJsonOutput),
		handleParameterCreate(d, sdk.AccountParameterTimestampDayIsAlways24h, &parameters.TimestampDayIsAlways24h),
		handleParameterCreate(d, sdk.AccountParameterTransactionAbortOnError, &parameters.TransactionAbortOnError),
		handleParameterCreate(d, sdk.AccountParameterUseCachedResult, &parameters.UseCachedResult),

		// Int parameters
		handleParameterCreate(d, sdk.AccountParameterClientEncryptionKeySize, &parameters.ClientEncryptionKeySize),
		handleParameterCreate(d, sdk.AccountParameterClientMemoryLimit, &parameters.ClientMemoryLimit),
		handleParameterCreate(d, sdk.AccountParameterClientPrefetchThreads, &parameters.ClientPrefetchThreads),
		handleParameterCreate(d, sdk.AccountParameterClientResultChunkSize, &parameters.ClientResultChunkSize),
		handleParameterCreate(d, sdk.AccountParameterClientSessionKeepAliveHeartbeatFrequency, &parameters.ClientSessionKeepAliveHeartbeatFrequency),
		handleParameterCreate(d, sdk.AccountParameterDataRetentionTimeInDays, &parameters.DataRetentionTimeInDays),
		handleParameterCreate(d, sdk.AccountParameterHybridTableLockTimeout, &parameters.HybridTableLockTimeout),
		handleParameterCreate(d, sdk.AccountParameterJsonIndent, &parameters.JsonIndent),
		handleParameterCreate(d, sdk.AccountParameterLockTimeout, &parameters.LockTimeout),
		handleParameterCreate(d, sdk.AccountParameterMaxConcurrencyLevel, &parameters.MaxConcurrencyLevel),
		handleParameterCreate(d, sdk.AccountParameterMaxDataExtensionTimeInDays, &parameters.MaxDataExtensionTimeInDays),
		handleParameterCreate(d, sdk.AccountParameterMinDataRetentionTimeInDays, &parameters.MinDataRetentionTimeInDays),
		handleParameterCreate(d, sdk.AccountParameterMultiStatementCount, &parameters.MultiStatementCount),
		handleParameterCreate(d, sdk.AccountParameterRowsPerResultset, &parameters.RowsPerResultset),
		handleParameterCreate(d, sdk.AccountParameterStatementTimeoutInSeconds, &parameters.StatementTimeoutInSeconds),
		handleParameterCreate(d, sdk.AccountParameterStatementQueuedTimeoutInSeconds, &parameters.StatementQueuedTimeoutInSeconds),
		handleParameterCreate(d, sdk.AccountParameterSuspendTaskAfterNumFailures, &parameters.SuspendTaskAfterNumFailures),
		handleParameterCreate(d, sdk.AccountParameterTaskAutoRetryAttempts, &parameters.TaskAutoRetryAttempts),
		handleParameterCreate(d, sdk.AccountParameterTwoDigitCenturyStart, &parameters.TwoDigitCenturyStart),
		handleParameterCreate(d, sdk.AccountParameterUserTaskMinimumTriggerIntervalInSeconds, &parameters.UserTaskMinimumTriggerIntervalInSeconds),
		handleParameterCreate(d, sdk.AccountParameterUserTaskTimeoutMs, &parameters.UserTaskTimeoutMs),
		handleParameterCreate(d, sdk.AccountParameterWeekOfYearPolicy, &parameters.WeekOfYearPolicy),
		handleParameterCreate(d, sdk.AccountParameterWeekStart, &parameters.WeekStart),

		// String parameters
		handleParameterCreateWithMapping(d, sdk.AccountParameterActivePythonProfiler, &parameters.ActivePythonProfiler, sdk.ToActivePythonProfiler),
		handleParameterCreate(d, sdk.AccountParameterBaseLocationPrefix, &parameters.BaseLocationPrefix),
		handleParameterCreateWithMapping(d, sdk.AccountParameterBinaryInputFormat, &parameters.BinaryInputFormat, sdk.ToBinaryInputFormat),
		handleParameterCreateWithMapping(d, sdk.AccountParameterBinaryOutputFormat, &parameters.BinaryOutputFormat, sdk.ToBinaryOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterCatalog, &parameters.Catalog),
		handleParameterCreate(d, sdk.AccountParameterCatalogSync, &parameters.CatalogSync),
		handleParameterCreateWithMapping(d, sdk.AccountParameterClientTimestampTypeMapping, &parameters.ClientTimestampTypeMapping, sdk.ToClientTimestampTypeMapping),
		handleParameterCreate(d, sdk.AccountParameterCortexEnabledCrossRegion, &parameters.CortexEnabledCrossRegion),
		handleParameterCreate(d, sdk.AccountParameterCortexModelsAllowlist, &parameters.CortexModelsAllowlist),
		handleParameterCreate(d, sdk.AccountParameterCsvTimestampFormat, &parameters.CsvTimestampFormat),
		handleParameterCreate(d, sdk.AccountParameterDateInputFormat, &parameters.DateInputFormat),
		handleParameterCreate(d, sdk.AccountParameterDateOutputFormat, &parameters.DateOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterDefaultDDLCollation, &parameters.DefaultDDLCollation),
		handleParameterCreate(d, sdk.AccountParameterDefaultNotebookComputePoolCpu, &parameters.DefaultNotebookComputePoolCpu),
		handleParameterCreate(d, sdk.AccountParameterDefaultNotebookComputePoolGpu, &parameters.DefaultNotebookComputePoolGpu),
		handleParameterCreateWithMapping(d, sdk.AccountParameterDefaultNullOrdering, &parameters.DefaultNullOrdering, sdk.ToDefaultNullOrdering),
		handleParameterCreateWithMapping(d, sdk.AccountParameterDefaultStreamlitNotebookWarehouse, &parameters.DefaultStreamlitNotebookWarehouse, sdk.ParseAccountObjectIdentifier),
		handleParameterCreateWithMapping(d, sdk.AccountParameterEventTable, &parameters.EventTable, sdk.ParseSchemaObjectIdentifier),
		handleParameterCreateWithMapping(d, sdk.AccountParameterExternalVolume, &parameters.ExternalVolume, sdk.ParseAccountObjectIdentifier),
		handleParameterCreateWithMapping(d, sdk.AccountParameterGeographyOutputFormat, &parameters.GeographyOutputFormat, sdk.ToGeographyOutputFormat),
		handleParameterCreateWithMapping(d, sdk.AccountParameterGeometryOutputFormat, &parameters.GeometryOutputFormat, sdk.ToGeometryOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterInitialReplicationSizeLimitInTB, &parameters.InitialReplicationSizeLimitInTB),
		handleParameterCreate(d, sdk.AccountParameterListingAutoFulfillmentReplicationRefreshSchedule, &parameters.ListingAutoFulfillmentReplicationRefreshSchedule),
		handleParameterCreateWithMapping(d, sdk.AccountParameterLogLevel, &parameters.LogLevel, sdk.ToLogLevel),
		handleParameterCreateWithMapping(d, sdk.AccountParameterMetricLevel, &parameters.MetricLevel, sdk.ToMetricLevel),
		handleParameterCreateWithMapping(d, sdk.AccountParameterNetworkPolicy, &parameters.NetworkPolicy, sdk.ParseAccountObjectIdentifier),
		handleParameterCreate(d, sdk.AccountParameterPythonProfilerModules, &parameters.PythonProfilerModules),
		handleParameterCreateWithMapping(d, sdk.AccountParameterPythonProfilerTargetStage, &parameters.PythonProfilerTargetStage, sdk.ParseSchemaObjectIdentifier),
		handleParameterCreate(d, sdk.AccountParameterQueryTag, &parameters.QueryTag),
		handleParameterCreate(d, sdk.AccountParameterS3StageVpceDnsName, &parameters.S3StageVpceDnsName),
		handleParameterCreate(d, sdk.AccountParameterSearchPath, &parameters.SearchPath),
		handleParameterCreateWithMapping(d, sdk.AccountParameterServerlessTaskMaxStatementSize, &parameters.ServerlessTaskMaxStatementSize, sdk.ToWarehouseSize),
		handleParameterCreateWithMapping(d, sdk.AccountParameterServerlessTaskMinStatementSize, &parameters.ServerlessTaskMinStatementSize, sdk.ToWarehouseSize),
		handleParameterCreate(d, sdk.AccountParameterSimulatedDataSharingConsumer, &parameters.SimulatedDataSharingConsumer),
		handleParameterCreateWithMapping(d, sdk.AccountParameterStorageSerializationPolicy, &parameters.StorageSerializationPolicy, sdk.ToStorageSerializationPolicy),
		handleParameterCreate(d, sdk.AccountParameterTimestampInputFormat, &parameters.TimestampInputFormat),
		handleParameterCreate(d, sdk.AccountParameterTimestampLtzOutputFormat, &parameters.TimestampLtzOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterTimestampNtzOutputFormat, &parameters.TimestampNtzOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterTimestampOutputFormat, &parameters.TimestampOutputFormat),
		handleParameterCreateWithMapping(d, sdk.AccountParameterTimestampTypeMapping, &parameters.TimestampTypeMapping, sdk.ToTimestampTypeMapping),
		handleParameterCreate(d, sdk.AccountParameterTimestampTzOutputFormat, &parameters.TimestampTzOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterTimezone, &parameters.Timezone),
		handleParameterCreate(d, sdk.AccountParameterTimeInputFormat, &parameters.TimeInputFormat),
		handleParameterCreate(d, sdk.AccountParameterTimeOutputFormat, &parameters.TimeOutputFormat),
		handleParameterCreateWithMapping(d, sdk.AccountParameterTraceLevel, &parameters.TraceLevel, sdk.ToTraceLevel),
		handleParameterCreateWithMapping(d, sdk.AccountParameterTransactionDefaultIsolationLevel, &parameters.TransactionDefaultIsolationLevel, sdk.ToTransactionDefaultIsolationLevel),
		handleParameterCreateWithMapping(d, sdk.AccountParameterUnsupportedDdlAction, &parameters.UnsupportedDdlAction, sdk.ToUnsupportedDDLAction),
		handleParameterCreateWithMapping(d, sdk.AccountParameterUserTaskManagedInitialWarehouseSize, &parameters.UserTaskManagedInitialWarehouseSize, sdk.ToWarehouseSize),
	)
	return diags
}

func handleAccountParametersUpdate(d *schema.ResourceData, set *sdk.AccountParameters, unset *sdk.AccountParametersUnset) diag.Diagnostics {
	diags := JoinDiags(
		// Bool parameters
		handleParameterUpdate(d, sdk.AccountParameterAbortDetachedQuery, &set.AbortDetachedQuery, &unset.AbortDetachedQuery),
		handleParameterUpdate(d, sdk.AccountParameterAllowClientMFACaching, &set.AllowClientMFACaching, &unset.AllowClientMFACaching),
		handleParameterUpdate(d, sdk.AccountParameterAllowIDToken, &set.AllowIDToken, &unset.AllowIDToken),
		handleParameterUpdate(d, sdk.AccountParameterAutocommit, &set.Autocommit, &unset.Autocommit),
		handleParameterUpdate(d, sdk.AccountParameterClientEnableLogInfoStatementParameters, &set.ClientEnableLogInfoStatementParameters, &unset.ClientEnableLogInfoStatementParameters),
		handleParameterUpdate(d, sdk.AccountParameterClientMetadataRequestUseConnectionCtx, &set.ClientMetadataRequestUseConnectionCtx, &unset.ClientMetadataRequestUseConnectionCtx),
		handleParameterUpdate(d, sdk.AccountParameterClientMetadataUseSessionDatabase, &set.ClientMetadataUseSessionDatabase, &unset.ClientMetadataUseSessionDatabase),
		handleParameterUpdate(d, sdk.AccountParameterClientResultColumnCaseInsensitive, &set.ClientResultColumnCaseInsensitive, &unset.ClientResultColumnCaseInsensitive),
		handleParameterUpdate(d, sdk.AccountParameterClientSessionKeepAlive, &set.ClientSessionKeepAlive, &unset.ClientSessionKeepAlive),
		handleParameterUpdate(d, sdk.AccountParameterDisableUiDownloadButton, &set.DisableUiDownloadButton, &unset.DisableUiDownloadButton),
		handleParameterUpdate(d, sdk.AccountParameterDisableUserPrivilegeGrants, &set.DisableUserPrivilegeGrants, &unset.DisableUserPrivilegeGrants),
		handleParameterUpdate(d, sdk.AccountParameterEnableAutomaticSensitiveDataClassificationLog, &set.EnableAutomaticSensitiveDataClassificationLog, &unset.EnableAutomaticSensitiveDataClassificationLog),
		handleParameterUpdate(d, sdk.AccountParameterEnableEgressCostOptimizer, &set.EnableEgressCostOptimizer, &unset.EnableEgressCostOptimizer),
		handleParameterUpdate(d, sdk.AccountParameterEnableIdentifierFirstLogin, &set.EnableIdentifierFirstLogin, &unset.EnableIdentifierFirstLogin),
		handleParameterUpdate(d, sdk.AccountParameterEnableInternalStagesPrivatelink, &set.EnableInternalStagesPrivatelink, &unset.EnableInternalStagesPrivatelink),
		handleParameterUpdate(d, sdk.AccountParameterEnableTriSecretAndRekeyOptOutForImageRepository, &set.EnableTriSecretAndRekeyOptOutForImageRepository, &unset.EnableTriSecretAndRekeyOptOutForImageRepository),
		handleParameterUpdate(d, sdk.AccountParameterEnableTriSecretAndRekeyOptOutForSpcsBlockStorage, &set.EnableTriSecretAndRekeyOptOutForSpcsBlockStorage, &unset.EnableTriSecretAndRekeyOptOutForSpcsBlockStorage),
		handleParameterUpdate(d, sdk.AccountParameterEnableUnhandledExceptionsReporting, &set.EnableUnhandledExceptionsReporting, &unset.EnableUnhandledExceptionsReporting),
		handleParameterUpdate(d, sdk.AccountParameterEnableUnloadPhysicalTypeOptimization, &set.EnableUnloadPhysicalTypeOptimization, &unset.EnableUnloadPhysicalTypeOptimization),
		handleParameterUpdate(d, sdk.AccountParameterEnableUnredactedQuerySyntaxError, &set.EnableUnredactedQuerySyntaxError, &unset.EnableUnredactedQuerySyntaxError),
		handleParameterUpdate(d, sdk.AccountParameterEnableUnredactedSecureObjectError, &set.EnableUnredactedSecureObjectError, &unset.EnableUnredactedSecureObjectError),
		handleParameterUpdate(d, sdk.AccountParameterEnforceNetworkRulesForInternalStages, &set.EnforceNetworkRulesForInternalStages, &unset.EnforceNetworkRulesForInternalStages),
		handleParameterUpdate(d, sdk.AccountParameterErrorOnNondeterministicMerge, &set.ErrorOnNondeterministicMerge, &unset.ErrorOnNondeterministicMerge),
		handleParameterUpdate(d, sdk.AccountParameterErrorOnNondeterministicUpdate, &set.ErrorOnNondeterministicUpdate, &unset.ErrorOnNondeterministicUpdate),
		handleParameterUpdate(d, sdk.AccountParameterExternalOAuthAddPrivilegedRolesToBlockedList, &set.ExternalOAuthAddPrivilegedRolesToBlockedList, &unset.ExternalOAuthAddPrivilegedRolesToBlockedList),
		handleParameterUpdate(d, sdk.AccountParameterJdbcTreatDecimalAsInt, &set.JdbcTreatDecimalAsInt, &unset.JdbcTreatDecimalAsInt),
		handleParameterUpdate(d, sdk.AccountParameterJdbcTreatTimestampNtzAsUtc, &set.JdbcTreatTimestampNtzAsUtc, &unset.JdbcTreatTimestampNtzAsUtc),
		handleParameterUpdate(d, sdk.AccountParameterJdbcUseSessionTimezone, &set.JdbcUseSessionTimezone, &unset.JdbcUseSessionTimezone),
		handleParameterUpdate(d, sdk.AccountParameterJsTreatIntegerAsBigInt, &set.JsTreatIntegerAsBigInt, &unset.JsTreatIntegerAsBigInt),
		handleParameterUpdate(d, sdk.AccountParameterNoorderSequenceAsDefault, &set.NoorderSequenceAsDefault, &unset.NoorderSequenceAsDefault),
		handleParameterUpdate(d, sdk.AccountParameterOAuthAddPrivilegedRolesToBlockedList, &set.OAuthAddPrivilegedRolesToBlockedList, &unset.OAuthAddPrivilegedRolesToBlockedList),
		handleParameterUpdate(d, sdk.AccountParameterOdbcTreatDecimalAsInt, &set.OdbcTreatDecimalAsInt, &unset.OdbcTreatDecimalAsInt),
		handleParameterUpdate(d, sdk.AccountParameterPeriodicDataRekeying, &set.PeriodicDataRekeying, &unset.PeriodicDataRekeying),
		handleParameterUpdate(d, sdk.AccountParameterPipeExecutionPaused, &set.PipeExecutionPaused, &unset.PipeExecutionPaused),
		handleParameterUpdate(d, sdk.AccountParameterPreventUnloadToInlineURL, &set.PreventUnloadToInlineURL, &unset.PreventUnloadToInlineURL),
		handleParameterUpdate(d, sdk.AccountParameterPreventUnloadToInternalStages, &set.PreventUnloadToInternalStages, &unset.PreventUnloadToInternalStages),
		handleParameterUpdate(d, sdk.AccountParameterQuotedIdentifiersIgnoreCase, &set.QuotedIdentifiersIgnoreCase, &unset.QuotedIdentifiersIgnoreCase),
		handleParameterUpdate(d, sdk.AccountParameterReplaceInvalidCharacters, &set.ReplaceInvalidCharacters, &unset.ReplaceInvalidCharacters),
		handleParameterUpdate(d, sdk.AccountParameterRequireStorageIntegrationForStageCreation, &set.RequireStorageIntegrationForStageCreation, &unset.RequireStorageIntegrationForStageCreation),
		handleParameterUpdate(d, sdk.AccountParameterRequireStorageIntegrationForStageOperation, &set.RequireStorageIntegrationForStageOperation, &unset.RequireStorageIntegrationForStageOperation),
		handleParameterUpdate(d, sdk.AccountParameterSsoLoginPage, &set.SsoLoginPage, &unset.SsoLoginPage),
		handleParameterUpdate(d, sdk.AccountParameterStrictJsonOutput, &set.StrictJsonOutput, &unset.StrictJsonOutput),
		handleParameterUpdate(d, sdk.AccountParameterTimestampDayIsAlways24h, &set.TimestampDayIsAlways24h, &unset.TimestampDayIsAlways24h),
		handleParameterUpdate(d, sdk.AccountParameterTransactionAbortOnError, &set.TransactionAbortOnError, &unset.TransactionAbortOnError),
		handleParameterUpdate(d, sdk.AccountParameterUseCachedResult, &set.UseCachedResult, &unset.UseCachedResult),

		// Int parameters
		handleParameterUpdate(d, sdk.AccountParameterClientEncryptionKeySize, &set.ClientEncryptionKeySize, &unset.ClientEncryptionKeySize),
		handleParameterUpdate(d, sdk.AccountParameterClientMemoryLimit, &set.ClientMemoryLimit, &unset.ClientMemoryLimit),
		handleParameterUpdate(d, sdk.AccountParameterClientPrefetchThreads, &set.ClientPrefetchThreads, &unset.ClientPrefetchThreads),
		handleParameterUpdate(d, sdk.AccountParameterClientResultChunkSize, &set.ClientResultChunkSize, &unset.ClientResultChunkSize),
		handleParameterUpdate(d, sdk.AccountParameterClientSessionKeepAliveHeartbeatFrequency, &set.ClientSessionKeepAliveHeartbeatFrequency, &unset.ClientSessionKeepAliveHeartbeatFrequency),
		handleParameterUpdate(d, sdk.AccountParameterDataRetentionTimeInDays, &set.DataRetentionTimeInDays, &unset.DataRetentionTimeInDays),
		handleParameterUpdate(d, sdk.AccountParameterHybridTableLockTimeout, &set.HybridTableLockTimeout, &unset.HybridTableLockTimeout),
		handleParameterUpdate(d, sdk.AccountParameterJsonIndent, &set.JsonIndent, &unset.JsonIndent),
		handleParameterUpdate(d, sdk.AccountParameterLockTimeout, &set.LockTimeout, &unset.LockTimeout),
		handleParameterUpdate(d, sdk.AccountParameterMaxConcurrencyLevel, &set.MaxConcurrencyLevel, &unset.MaxConcurrencyLevel),
		handleParameterUpdate(d, sdk.AccountParameterMaxDataExtensionTimeInDays, &set.MaxDataExtensionTimeInDays, &unset.MaxDataExtensionTimeInDays),
		handleParameterUpdate(d, sdk.AccountParameterMinDataRetentionTimeInDays, &set.MinDataRetentionTimeInDays, &unset.MinDataRetentionTimeInDays),
		handleParameterUpdate(d, sdk.AccountParameterMultiStatementCount, &set.MultiStatementCount, &unset.MultiStatementCount),
		handleParameterUpdate(d, sdk.AccountParameterRowsPerResultset, &set.RowsPerResultset, &unset.RowsPerResultset),
		handleParameterUpdate(d, sdk.AccountParameterStatementTimeoutInSeconds, &set.StatementTimeoutInSeconds, &unset.StatementTimeoutInSeconds),
		handleParameterUpdate(d, sdk.AccountParameterStatementQueuedTimeoutInSeconds, &set.StatementQueuedTimeoutInSeconds, &unset.StatementQueuedTimeoutInSeconds),
		handleParameterUpdate(d, sdk.AccountParameterSuspendTaskAfterNumFailures, &set.SuspendTaskAfterNumFailures, &unset.SuspendTaskAfterNumFailures),
		handleParameterUpdate(d, sdk.AccountParameterTaskAutoRetryAttempts, &set.TaskAutoRetryAttempts, &unset.TaskAutoRetryAttempts),
		handleParameterUpdate(d, sdk.AccountParameterTwoDigitCenturyStart, &set.TwoDigitCenturyStart, &unset.TwoDigitCenturyStart),
		handleParameterUpdate(d, sdk.AccountParameterUserTaskMinimumTriggerIntervalInSeconds, &set.UserTaskMinimumTriggerIntervalInSeconds, &unset.UserTaskMinimumTriggerIntervalInSeconds),
		handleParameterUpdate(d, sdk.AccountParameterUserTaskTimeoutMs, &set.UserTaskTimeoutMs, &unset.UserTaskTimeoutMs),
		handleParameterUpdate(d, sdk.AccountParameterWeekOfYearPolicy, &set.WeekOfYearPolicy, &unset.WeekOfYearPolicy),
		handleParameterUpdate(d, sdk.AccountParameterWeekStart, &set.WeekStart, &unset.WeekStart),

		// String parameters
		handleParameterUpdateWithMapping(d, sdk.AccountParameterActivePythonProfiler, &set.ActivePythonProfiler, &unset.ActivePythonProfiler, sdk.ToActivePythonProfiler),
		handleParameterUpdate(d, sdk.AccountParameterBaseLocationPrefix, &set.BaseLocationPrefix, &unset.BaseLocationPrefix),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterBinaryInputFormat, &set.BinaryInputFormat, &unset.BinaryInputFormat, sdk.ToBinaryInputFormat),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterBinaryOutputFormat, &set.BinaryOutputFormat, &unset.BinaryOutputFormat, sdk.ToBinaryOutputFormat),
		handleParameterUpdate(d, sdk.AccountParameterCatalog, &set.Catalog, &unset.Catalog),
		handleParameterUpdate(d, sdk.AccountParameterCatalogSync, &set.CatalogSync, &unset.CatalogSync),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterClientTimestampTypeMapping, &set.ClientTimestampTypeMapping, &unset.ClientTimestampTypeMapping, sdk.ToClientTimestampTypeMapping),
		handleParameterUpdate(d, sdk.AccountParameterCortexEnabledCrossRegion, &set.CortexEnabledCrossRegion, &unset.CortexEnabledCrossRegion),
		handleParameterUpdate(d, sdk.AccountParameterCortexModelsAllowlist, &set.CortexModelsAllowlist, &unset.CortexModelsAllowlist),
		handleParameterUpdate(d, sdk.AccountParameterCsvTimestampFormat, &set.CsvTimestampFormat, &unset.CsvTimestampFormat),
		handleParameterUpdate(d, sdk.AccountParameterDateInputFormat, &set.DateInputFormat, &unset.DateInputFormat),
		handleParameterUpdate(d, sdk.AccountParameterDateOutputFormat, &set.DateOutputFormat, &unset.DateOutputFormat),
		handleParameterUpdate(d, sdk.AccountParameterDefaultDDLCollation, &set.DefaultDDLCollation, &unset.DefaultDDLCollation),
		handleParameterUpdate(d, sdk.AccountParameterDefaultNotebookComputePoolCpu, &set.DefaultNotebookComputePoolCpu, &unset.DefaultNotebookComputePoolCpu),
		handleParameterUpdate(d, sdk.AccountParameterDefaultNotebookComputePoolGpu, &set.DefaultNotebookComputePoolGpu, &unset.DefaultNotebookComputePoolGpu),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterDefaultNullOrdering, &set.DefaultNullOrdering, &unset.DefaultNullOrdering, sdk.ToDefaultNullOrdering),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterDefaultStreamlitNotebookWarehouse, &set.DefaultStreamlitNotebookWarehouse, &unset.DefaultStreamlitNotebookWarehouse, sdk.ParseAccountObjectIdentifier),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterEventTable, &set.EventTable, &unset.EventTable, sdk.ParseSchemaObjectIdentifier),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterExternalVolume, &set.ExternalVolume, &unset.ExternalVolume, sdk.ParseAccountObjectIdentifier),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterGeographyOutputFormat, &set.GeographyOutputFormat, &unset.GeographyOutputFormat, sdk.ToGeographyOutputFormat),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterGeometryOutputFormat, &set.GeometryOutputFormat, &unset.GeometryOutputFormat, sdk.ToGeometryOutputFormat),
		handleParameterUpdate(d, sdk.AccountParameterInitialReplicationSizeLimitInTB, &set.InitialReplicationSizeLimitInTB, &unset.InitialReplicationSizeLimitInTB),
		handleParameterUpdate(d, sdk.AccountParameterListingAutoFulfillmentReplicationRefreshSchedule, &set.ListingAutoFulfillmentReplicationRefreshSchedule, &unset.ListingAutoFulfillmentReplicationRefreshSchedule),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterLogLevel, &set.LogLevel, &unset.LogLevel, sdk.ToLogLevel),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterMetricLevel, &set.MetricLevel, &unset.MetricLevel, sdk.ToMetricLevel),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterNetworkPolicy, &set.NetworkPolicy, &unset.NetworkPolicy, sdk.ParseAccountObjectIdentifier),
		handleParameterUpdate(d, sdk.AccountParameterPythonProfilerModules, &set.PythonProfilerModules, &unset.PythonProfilerModules),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterPythonProfilerTargetStage, &set.PythonProfilerTargetStage, &unset.PythonProfilerTargetStage, sdk.ParseSchemaObjectIdentifier),
		handleParameterUpdate(d, sdk.AccountParameterQueryTag, &set.QueryTag, &unset.QueryTag),
		handleParameterUpdate(d, sdk.AccountParameterS3StageVpceDnsName, &set.S3StageVpceDnsName, &unset.S3StageVpceDnsName),
		handleParameterUpdate(d, sdk.AccountParameterSearchPath, &set.SearchPath, &unset.SearchPath),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterServerlessTaskMaxStatementSize, &set.ServerlessTaskMaxStatementSize, &unset.ServerlessTaskMaxStatementSize, sdk.ToWarehouseSize),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterServerlessTaskMinStatementSize, &set.ServerlessTaskMinStatementSize, &unset.ServerlessTaskMinStatementSize, sdk.ToWarehouseSize),
		handleParameterUpdate(d, sdk.AccountParameterSimulatedDataSharingConsumer, &set.SimulatedDataSharingConsumer, &unset.SimulatedDataSharingConsumer),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterStorageSerializationPolicy, &set.StorageSerializationPolicy, &unset.StorageSerializationPolicy, sdk.ToStorageSerializationPolicy),
		handleParameterUpdate(d, sdk.AccountParameterTimestampInputFormat, &set.TimestampInputFormat, &unset.TimestampInputFormat),
		handleParameterUpdate(d, sdk.AccountParameterTimestampLtzOutputFormat, &set.TimestampLtzOutputFormat, &unset.TimestampLtzOutputFormat),
		handleParameterUpdate(d, sdk.AccountParameterTimestampNtzOutputFormat, &set.TimestampNtzOutputFormat, &unset.TimestampNtzOutputFormat),
		handleParameterUpdate(d, sdk.AccountParameterTimestampOutputFormat, &set.TimestampOutputFormat, &unset.TimestampOutputFormat),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterTimestampTypeMapping, &set.TimestampTypeMapping, &unset.TimestampTypeMapping, sdk.ToTimestampTypeMapping),
		handleParameterUpdate(d, sdk.AccountParameterTimestampTzOutputFormat, &set.TimestampTzOutputFormat, &unset.TimestampTzOutputFormat),
		handleParameterUpdate(d, sdk.AccountParameterTimezone, &set.Timezone, &unset.Timezone),
		handleParameterUpdate(d, sdk.AccountParameterTimeInputFormat, &set.TimeInputFormat, &unset.TimeInputFormat),
		handleParameterUpdate(d, sdk.AccountParameterTimeOutputFormat, &set.TimeOutputFormat, &unset.TimeOutputFormat),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterTraceLevel, &set.TraceLevel, &unset.TraceLevel, sdk.ToTraceLevel),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterTransactionDefaultIsolationLevel, &set.TransactionDefaultIsolationLevel, &unset.TransactionDefaultIsolationLevel, sdk.ToTransactionDefaultIsolationLevel),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterUnsupportedDdlAction, &set.UnsupportedDdlAction, &unset.UnsupportedDdlAction, sdk.ToUnsupportedDDLAction),
		handleParameterUpdateWithMapping(d, sdk.AccountParameterUserTaskManagedInitialWarehouseSize, &set.UserTaskManagedInitialWarehouseSize, &unset.UserTaskManagedInitialWarehouseSize, sdk.ToWarehouseSize),
	)
	return diags
}
